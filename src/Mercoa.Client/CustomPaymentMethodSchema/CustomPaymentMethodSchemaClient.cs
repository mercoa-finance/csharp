...
public partial class CustomPaymentMethodSchemaClient
{
    private RawClient _client;

    internal CustomPaymentMethodSchemaClient(RawClient client)
    {
        _client = client;
    }
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            try
            {
                return JsonUtils.Deserialize<IEnumerable<CustomPaymentMethodSchemaResponse>>(
                    responseBody
                )!;
            }
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            try
            {
                return JsonUtils.Deserialize<CustomPaymentMethodSchemaResponse>(responseBody)!;
            }
            catch (JsonException e)
            {
                throw new MercoaException("Failed to deserialize response", e);
    ...
    /// </summary>
    public async Task<CustomPaymentMethodSchemaResponse> GetAsync(
        string schemaId,
        RequestOptions? options = null
    )
    {
    ...
    /// </summary>
    public async Task DeleteAsync(string schemaId, RequestOptions? options = null)
    {
        var response = await _client.MakeRequestAsync(
            new RawClient.JsonApiRequest
            {
