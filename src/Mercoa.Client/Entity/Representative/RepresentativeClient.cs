...
public partial class RepresentativeClient
{
    private RawClient _client;

    internal RepresentativeClient(RawClient client)
    {
        _client = client;
    }
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            try
            {
                return JsonUtils.Deserialize<IEnumerable<RepresentativeResponse>>(responseBody)!;
            }
    ...
    public async Task<RepresentativeResponse> GetAsync(
        string entityId,
