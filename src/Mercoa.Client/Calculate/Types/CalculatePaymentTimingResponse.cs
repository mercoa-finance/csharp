...
public record CalculatePaymentTimingResponse
{
    ...
    public required DateTime EstimatedProcessingDate { get; init; }
    ...
    public required int BusinessDays { get; init; }
    ...
    public required DateTime EstimatedSettlementDate { get; init; }
}
