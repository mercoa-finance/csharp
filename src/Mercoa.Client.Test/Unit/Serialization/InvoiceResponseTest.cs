...
";
        ...
        var deserializedObject = JsonSerializer.Deserialize<InvoiceResponse>(
            inputJson,
            serializerOptions
        );
...
";
    ...
    [Test]
    public void TestSerialization_12()
    {
        var inputJson =
            @"
        {
...
";
    ...
    [Test]
    public void TestSerialization_13()
    {
        var inputJson =
            @"
        {
...
";
    ...
    [Test]
    public void TestSerialization_14()
    {
        var inputJson =
            @"
        {
